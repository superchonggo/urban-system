...
using GapFillUtility.Services.Processors;
...
namespace GapFillUtility.Services
{
    public class GapFillUtilityExecutor : ILoader
    {
        ...
        private async Task FillGapsAsync(IEnumerable<string> lstProducts, string productVersion)
        {
            ...
            Helpers.DisplayHeader("GapFill Utility");
            ...
            foreach (var product in lstProducts)
            {
                ...
                var requestUri = BuildHarvestingServiceUrl(product, productVersion, null);
        ...
        //private async Task FillGapsAsync2(IEnumerable<string> lstProducts, string productVersion)
        //{
        //    // Begin timing.
        //    var stopwatch = new Stopwatch();
        //    stopwatch.Start();
